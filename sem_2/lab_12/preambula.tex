...
%\usepackage{diagbox} %Для диагонально полоски в ячейки таблицы
%\usepackage{slashbox}
...
\captionsetup[longtable]{labelsep=dash,justification=raggedright,singlelinecheck=off}
...
\lstset{ %
	language=C,                 % выбор языка для подсветки				(caml - C, C++ -- C++, [x86masm]Assembler, Python, SQL)
...
\newtcblisting[use counter=lstlisting]{mylisting}[3]{
	boxrule=1pt,
	titlerule=1pt,
	breakable,
	colback=white,
	...
	title after break={Продолжение листинга~\thelstlisting},
	label={#2},
}
